...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jrj0sly.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jrj0sly.containers.anotherwebservice.com/
...
```
git clone git@github.com:lucaL99/container-jrj0sly.git
cd container-jrj0sly
```
...
```
docker attach container-jrj0sly
```
